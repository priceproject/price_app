...
class OutreachBookScreen extends StatefulWidget {
  const OutreachBookScreen({super.key});

  @override
  State<OutreachBookScreen> createState() => _OutreachBookScreenState();
}

class _OutreachBookScreenState extends State<OutreachBookScreen> {

  bool isSearching = false;
  int _currentIndex = 0;

  String _activeCategory = "Outreach";
          ...
          Expanded(
            child: Padding(
              ...
              child: GridView.builder(
                  ...
                  itemCount: outreachBookData.length,
                  itemBuilder: (context, index) {
                    final book = outreachBookData[index];
